...
@Slf4j
@Entity
@Table(name = "course_questions", schema = "web_service")
@Getter
...
public class CourseQuestion extends BaseEntity {
    ...
    @OneToMany(mappedBy = "courseQuestion", cascade = CascadeType.PERSIST, orphanRemoval = true)
    @Builder.Default
    private List<CourseQuestionFile> attachments = new ArrayList<>();
    ...
    private CourseAnswer acceptedAnswer;
    ...
    public void acceptAnswer(CourseAnswer answer) {
