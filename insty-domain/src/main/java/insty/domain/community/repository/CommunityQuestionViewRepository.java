...
public interface CommunityQuestionViewRepository extends JpaRepository<CommunityQuestionView, CommunityQuestionViewId> {

	@Query("SELECT v FROM CommunityQuestionView v WHERE v.communityQuestion.id = :questionId AND v.communityQuestionViewId.userId = :userId")
