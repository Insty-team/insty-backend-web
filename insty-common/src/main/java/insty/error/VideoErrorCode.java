...
public enum VideoErrorCode implements ErrorCode {
    ...
    VIDEO_NOT_FOUND("VIDEO_005", "존재하지 않는 영상입니다.", 404),
    VIDEO_NOT_FINISHED_ENCODING("VIDEO_006", "인코딩이 완료되지 않았습니다.", 409),
    VIDEO_INVALID_ENCODING_KEY("VIDEO_007", "인코딩 키의 값이 유효하지 않습니다.", 500),
