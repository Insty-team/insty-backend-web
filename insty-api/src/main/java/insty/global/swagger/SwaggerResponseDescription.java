...
public enum SwaggerResponseDescription {
    ...
    COURSE_QUESTION_DETAIL(new LinkedHashSet<>(Set.of(
            COURSE_QUESTION_ID_IS_REQUIRED,
            COURSE_QUESTION_NOT_FOUND,
            COURSE_QUESTION_ALREADY_DELETED
    ))),
    COURSE_QUESTION_CREATE(new LinkedHashSet<>(Set.of(
            USER_NOT_FOUND,
            COURSE_NOT_FOUND,
            VIDEO_NOT_FOUND,
            COURSE_CONTENT_IS_REQUIRED,
            COURSE_FILE_IS_EMPTY
    ))),
    COURSE_QUESTION_UPDATE(new LinkedHashSet<>(Set.of(
            COURSE_QUESTION_ID_IS_REQUIRED,
            COURSE_QUESTION_NOT_FOUND,
            COURSE_QUESTION_ALREADY_DELETED,
            COURSE_NOT_QUESTION_AUTHOR,
            COURSE_CONTENT_IS_REQUIRED,
            COURSE_FILE_IS_EMPTY,
            VIDEO_NOT_FOUND
    ))),
    ...
    COURSE_ANSWER_CREATE(new LinkedHashSet<>(Set.of(
            ...
            COURSE_CONTENT_IS_REQUIRED,
            COURSE_FILE_IS_EMPTY,
            COURSE_MAX_FILE_COUNT_EXCEEDED,
            VIDEO_NOT_FOUND
    ))),
    COURSE_ANSWER_UPDATE(new LinkedHashSet<>(Set.of(
            COURSE_ANSWER_ID_IS_REQUIRED,
            COURSE_ANSWER_NOT_FOUND,
            COURSE_MAX_FILE_COUNT_EXCEEDED,
            COURSE_CONTENT_IS_REQUIRED,
            COURSE_ANSWER_ALREADY_DELETED,
            COURSE_NOT_ANSWER_AUTHOR,
            COURSE_FILE_IS_EMPTY,
            VIDEO_NOT_FOUND
    ))),
    ...
    COURSE_ANSWER_ACCEPT(new LinkedHashSet<>(Set.of(
            ...
            COURSE_ANSWER_ALREADY_DELETED,
            COURSE_NOT_ANSWER_AUTHOR,
            COURSE_ANSWER_NOT_BELONG_TO_QUESTION,
            COURSE_ANSWER_INVALID_USER_ID,
            COURSE_ALREADY_ACCEPTED_ANSWER,
            COURSE_ANSWER_ACCEPT_PERMISSION_DENIED
    ))),
