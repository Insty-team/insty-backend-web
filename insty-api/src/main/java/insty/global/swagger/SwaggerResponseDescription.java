...
import static insty.error.VideoErrorCode.*;
import static insty.error.NotificationErrorCode.*;
...
public enum SwaggerResponseDescription {
    ...
    COURSE_QUESTION_COURSE_SEARCH(new LinkedHashSet<>(Set.of(
    ))),
    COURSE_QUESTION_DETAIL(new LinkedHashSet<>(Set.of(
            COURSE_QNA_QUESTION_ID_IS_REQUIRED,
            COURSE_QNA_QUESTION_NOT_FOUND,
            COURSE_QNA_QUESTION_ALREADY_DELETED
    ))),
    COURSE_QUESTION_CREATE(new LinkedHashSet<>(Set.of(
            USER_NOT_FOUND,
            COURSE_NOT_FOUND,
            VIDEO_NOT_FOUND,
            COURSE_QNA_CONTENT_IS_REQUIRED,
            COURSE_QNA_FILE_IS_EMPTY
    ))),
    COURSE_QUESTION_UPDATE(new LinkedHashSet<>(Set.of(
            COURSE_QNA_QUESTION_ID_IS_REQUIRED,
            COURSE_QNA_QUESTION_NOT_FOUND,
            COURSE_QNA_QUESTION_ALREADY_DELETED,
            COURSE_QNA_NOT_QUESTION_AUTHOR,
            COURSE_QNA_CONTENT_IS_REQUIRED,
            COURSE_QNA_FILE_IS_EMPTY,
            VIDEO_NOT_FOUND
    ))),
    COURSE_QUESTION_DELETE(new LinkedHashSet<>(Set.of(
            COURSE_QNA_QUESTION_ID_IS_REQUIRED,
            COURSE_QNA_QUESTION_NOT_FOUND,
            COURSE_QNA_QUESTION_ALREADY_DELETED,
            COURSE_QNA_NOT_QUESTION_AUTHOR
    ))),
    COURSE_ANSWER_SEARCH(new LinkedHashSet<>(Set.of(
            COURSE_QNA_QUESTION_ID_IS_REQUIRED,
            COURSE_QNA_QUESTION_NOT_FOUND
    ))),
    COURSE_ANSWER_ACCEPTED_SEARCH(new LinkedHashSet<>(Set.of(
            COURSE_QNA_QUESTION_ID_IS_REQUIRED,
            COURSE_QNA_QUESTION_NOT_FOUND
    ))),
    COURSE_ANSWER_CREATE(new LinkedHashSet<>(Set.of(
            COURSE_QNA_QUESTION_ID_IS_REQUIRED,
            COURSE_QNA_QUESTION_NOT_FOUND,
            USER_NOT_FOUND,
            COURSE_QNA_CONTENT_IS_REQUIRED,
            COURSE_QNA_FILE_IS_EMPTY,
            COURSE_QNA_MAX_FILE_COUNT_EXCEEDED,
            VIDEO_NOT_FOUND
    ))),
    COURSE_ANSWER_UPDATE(new LinkedHashSet<>(Set.of(
            COURSE_QNA_ANSWER_ID_IS_REQUIRED,
            COURSE_QNA_ANSWER_NOT_FOUND,
            COURSE_QNA_MAX_FILE_COUNT_EXCEEDED,
            COURSE_QNA_CONTENT_IS_REQUIRED,
            COURSE_QNA_ANSWER_ALREADY_DELETED,
            COURSE_QNA_NOT_ANSWER_AUTHOR,
            COURSE_QNA_FILE_IS_EMPTY,
            VIDEO_NOT_FOUND
    ))),
    COURSE_ANSWER_DELETE(new LinkedHashSet<>(Set.of(
            COURSE_QNA_ANSWER_ID_IS_REQUIRED,
            COURSE_QNA_ANSWER_NOT_FOUND,
            COURSE_QNA_ANSWER_ALREADY_DELETED,
            COURSE_QNA_NOT_ANSWER_AUTHOR
    ))),
    COURSE_ANSWER_ACCEPT(new LinkedHashSet<>(Set.of(
            COURSE_QNA_QUESTION_ID_IS_REQUIRED,
            COURSE_QNA_ANSWER_ID_IS_REQUIRED,
            COURSE_QNA_QUESTION_NOT_FOUND,
            COURSE_QNA_ANSWER_NOT_FOUND,
            ...
            COURSE_QNA_ANSWER_ALREADY_DELETED,
            COURSE_QNA_NOT_ANSWER_AUTHOR,
            COURSE_QNA_ANSWER_NOT_BELONG_TO_QUESTION,
            COURSE_QNA_ANSWER_INVALID_USER_ID,
            COURSE_QNA_ALREADY_ACCEPTED_ANSWER,
            COURSE_QNA_ANSWER_ACCEPT_PERMISSION_DENIED
    ))),

    // notification
    NOTIFICATION_SEARCH(new LinkedHashSet<>(Set.of(
            USER_NOT_FOUND
    ))),
    ...
    NOTIFICATION_SETTING_UPDATE(new LinkedHashSet<>(Set.of(
            USER_NOT_FOUND
    ))),

    NOTIFICATION_SETTING_BULK_UPDATE(new LinkedHashSet<>(Set.of(
            USER_NOT_FOUND
    )))
