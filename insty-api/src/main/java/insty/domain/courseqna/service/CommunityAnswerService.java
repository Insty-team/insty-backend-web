...
import insty.domain.courseqna.implement.CommunityMentionManager;
...
public class CommunityAnswerService {
    ...
    public CommunityAnswerRes saveAnswer(Long userId, Long questionId, CommunityAnswerCreateReq req, List<MultipartFile> attachments) {
        ...
        CourseAnswer answer = communityAnswerWriter.saveAnswer(user, question, req);
    ...
    public CommunityAnswerRes updateAnswer(Long userId, Long answerId, CommunityAnswerUpdateReq req, List<MultipartFile> attachments) {
        ...
        CourseAnswer current = communityAnswerReader.getCommunityAnswerById(answerId);
        ...
        CourseAnswer updatedAnswer = communityAnswerWriter.updateAnswer(answerId, req);
    ...
    public List<CommunityAnswerRes> getAllAnswersByQuestionId(Long questionId) {
        ...
        List<CourseAnswer> answers = communityAnswerReader.getAllCommunityAnswersByQuestionId(questionId);
    ...
    public SearchRes<CommunityAnswerRes> getAnswersByQuestionId(Long questionId, CommunityAnswerSearchReq req) {
        ...
        Page<CourseAnswer> answersPage = communityAnswerReader.getCommunityAnswersByQuestionIdWithPagination(questionId, req.toPaginationReq());
    ...
    public CommunityAnswerRes getAnswerDetails(Long answerId) {
        CourseAnswer answer = communityAnswerReader.getCommunityAnswerById(answerId);
    ...
    public List<CommunityAnswerRes> getAcceptedAnswers(Long questionId) {
        ...
        List<CourseAnswer> acceptedAnswers = communityAnswerReader.getAcceptedAnswersByQuestionId(questionId);
