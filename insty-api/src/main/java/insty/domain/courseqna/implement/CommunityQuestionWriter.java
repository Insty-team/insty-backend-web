...
public class CommunityQuestionWriter {
     ...
     * 커뮤니티 질문 생성 및 저장
     */
    public CourseQuestion saveQuestion(User user, Course course, CommunityQuestionCreateReq req) {
     ...
     */
    public CourseQuestion updateQuestion(Long questionId, CommunityQuestionUpdateReq req) {
