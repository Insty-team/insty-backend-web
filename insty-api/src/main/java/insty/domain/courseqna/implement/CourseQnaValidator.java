...
public class CourseQnaValidator {
    ...
    public void validateQuestionAuthor(Long userId, Long questionId) {
        ...
        if (!authorId.equals(userId)) {
            throw new CustomException(CourseQnaErrorCode.COURSE_QNA_NOT_QUESTION_AUTHOR);
        }
    }
    ...
    public void validateAnswerAuthor(Long userId, CourseAnswer answer) {
        ...
        if (!authorId.equals(userId)) {
            throw new CustomException(CourseQnaErrorCode.COURSE_QNA_NOT_ANSWER_AUTHOR);
        }
    }
    ...
    public void validateAnswerBelongsToQuestion(CourseAnswer answer, CourseQuestion question) {
        if (!answer.getCourseQuestion().getId().equals(question.getId())) {
            throw new CustomException(CourseQnaErrorCode.COURSE_QNA_ANSWER_NOT_BELONG_TO_QUESTION);
        }
    }
    ...
    public void validateContent(String content) {
        if (content == null || content.trim().isEmpty()) {
            throw new CustomException(CourseQnaErrorCode.COURSE_QNA_CONTENT_IS_REQUIRED);
        }
    }
    ...
    public void validateFiles(List<MultipartFile> files) {
        ...
        for (MultipartFile file : files) {
            if (file.isEmpty()) {
                throw new CustomException(CourseQnaErrorCode.COURSE_QNA_FILE_IS_EMPTY);
            }
    ...
    public UUID validateAndParseVideoUuid(String videoUuid) {
        ...
        try {
            ...
            throw new CustomException(CourseQnaErrorCode.COURSE_QNA_INVALID_VIDEO_UUID);
        }
    }
    ...
    public void validateQuestionFileCount(List<MultipartFile> files) {
        ...
        if (fileCount > MAX_QUESTION_FILE_COUNT) {
            throw new CustomException(CourseQnaErrorCode.COURSE_QNA_MAX_FILE_COUNT_EXCEEDED);
        }
    }
