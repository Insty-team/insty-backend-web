...
public class CourseQuestionVideoManager {
     ...
     * 질문에 비디오 첨부
     */
    public VideoQuestion attachVideoToQuestion(CourseQuestion question, UUID videoUuid) {
        if(videoUuid == null){
            return null;
        }
     ...
     */
    public VideoQuestion updateAndGetLinkedVideo(CourseQuestion question, UUID videoUuid) {
     ...
     */
    public VideoQuestion getVideoQuestion(CourseQuestion question) {
        return videoQuestionRepository.findByCourseQuestionIdAndIsDeleted(question.getId(), false)
                .orElse(null);
    }
     ...
     * 비디오를 완전 삭제한다
     */
    public void deleteQuestionVideo(CourseQuestion question){
