...
@Transactional
public class CommunityMentionManager {
     ...
     * @return 맨션된 사용자 목록
     */
    public List<User> processMentions(CommunityAnswer answer, User mentionerUser, String content) {
        ...
        mentionNotificationManager.sendMentionsNotification(savedMentions, answer.getCommunityQuestion());
