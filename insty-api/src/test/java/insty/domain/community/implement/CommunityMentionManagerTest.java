...
class CommunityMentionManagerTest {

    @InjectMocks
    private CommunityMentionManager communityMentionManager;
    ...
    void processMentions_정상_맨션된사용자목록반환() {
        // given
        CommunityQuestion question = CommunityQuestionFixtureBuilder.getCommunityQuestionWithIdAndUser(1L, "질문 제목", "질문 내용");
        CommunityAnswer answer = CommunityAnswerFixtureBuilder.getCommunityAnswerWithIdAndUser(question, 1L, "답변 내용");
        ...
        // when
        List<User> result = communityMentionManager.processMentions(answer, mentionerUser, content);
