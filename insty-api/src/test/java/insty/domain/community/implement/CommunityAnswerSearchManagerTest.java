...
class CommunityAnswerSearchManagerTest {
    ...
    void getAnswersByQuestionId_정상() {
        ...
        Page<CommunityAnswer> answerPage = new PageImpl<>(answers, PageRequest.of(0, 10), 2);
    ...
    void getAnswersByQuestionId_페이지2_정상() {
        ...
        Page<CommunityAnswer> answerPage = new PageImpl<>(answers, PageRequest.of(1, 5), 10); // total 10 items
