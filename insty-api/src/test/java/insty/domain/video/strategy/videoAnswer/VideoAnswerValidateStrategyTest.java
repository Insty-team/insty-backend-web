...
class VideoAnswerValidateStrategyTest {
    ...
    void validateUploadable_정상_오늘_생성한_영상_총_길이가_10분_미만이다() {
        ...
        // then
        assertThatCode(() -> videoAnswerValidateStrategy.validateUploadable(userId))
    ...
    void validateUploadable_에러_오늘_생성한_영상_총_길이가_10분_이상이다() {
        ...
        // then
        assertThatThrownBy(() -> videoAnswerValidateStrategy.validateUploadable(userId))
    ...
    void validateReadable_정상() {
        ...
        // mock
        when(videoAnswerRepository.existsByIdAndUserId(videoId, userId))
                .thenReturn(true);
    ...
    void validateReadable_에러_영상_조회가_가능한_사람이_아니다() {
        ...
        // then
        assertThatThrownBy(() -> videoAnswerValidateStrategy.validateReadable(userId, videoId))
                .isInstanceOf(CustomException.class)
                .extracting(e -> ((CustomException) e).getErrorCode())
    ...
    void verifyEncodingCompletedAndDeleted_정상() {
        ...
        // then
        assertThatCode(() -> videoAnswerValidateStrategy.verifyEncodingCompletedAndDeleted(id))
                .doesNotThrowAnyException();
    }
    ...
    void verifyEncodingCompletedAndDeleted_에러_영상이_조회되지_않음() {
        ...
        // then
        assertThatThrownBy(() -> videoAnswerValidateStrategy.verifyEncodingCompletedAndDeleted(id))
                .isInstanceOf(CustomException.class)
                .extracting(e -> ((CustomException) e).getErrorCode())
