...
class CourseQuestionServiceTest {
    ...
    @Sql(statements = {
            ...
            "INSERT INTO web_service.course_question_files (question_id, file_id, created_at, updated_at) VALUES (1, 101, NOW(), NOW());",
            ...
            "INSERT INTO web_service.course_answers_files (answer_id, file_id, created_at, updated_at) VALUES (2, 200, NOW(), NOW());",
    ...
    @Sql(statements = {
            ...
            // 질문1 조회 기록
            "INSERT INTO web_service.course_question_views (question_id, user_id, last_viewed_at) "
    ...
    @Sql(statements = {
            ...
            "INSERT INTO web_service.course_questions (id, user_id, course_id, title, content, status, created_at, updated_at, is_deleted) VALUES (1, 1, 1, '테스트 질문', '테스트 내용', 'WAITING', NOW(), NOW(), false)"
    })
    void recordQuestionViewIfAuthorOrCreator_정상() throws InterruptedException {
        ...
        assertThat(authorView.getCourseQuestion().getId()).isEqualTo(questionId);
        assertThat(authorView.getCourseQuestionViewId().getUserId()).isEqualTo(questionAuthorId);
        ...
        assertThat(creatorView.getCourseQuestion().getId()).isEqualTo(questionId);
        assertThat(creatorView.getCourseQuestionViewId().getUserId()).isEqualTo(courseCreatorId);
        ...
        CourseQuestionView authorViewAfter = courseQuestionViewRepository.findByQuestionIdAndUserId(questionId, questionAuthorId).orElse(null);
        CourseQuestionView creatorViewAfter = courseQuestionViewRepository.findByQuestionIdAndUserId(questionId, courseCreatorId).orElse(null);
